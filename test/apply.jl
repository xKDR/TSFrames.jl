...
@test typeof(ts_monthly) == TimeFrames.TSFrame
...
@test typeof(ts_yearly) == TimeFrames.TSFrame
...
@test typeof(ts_weekly) == TimeFrames.TSFrame
...
@test typeof(ts_quarterly) == TimeFrames.TSFrame
...
@test typeof(ts_test_daily) == TimeFrames.TSFrame
...
@test typeof(ts_hourly) == TimeFrames.TSFrame
...
@test typeof(ts_minutely) == TimeFrames.TSFrame
...
@test typeof(ts_secondly) == TimeFrames.TSFrame
